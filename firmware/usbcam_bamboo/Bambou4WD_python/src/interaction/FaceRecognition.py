...
#subjects = ["unknow", "Olivier", "Emma","Marion","Tiphaine","delahousse_JT","Yann Barthès"]
subjects = []
    
class FaceRecognition (object):
    
    def __init__(self):    
        print("FaceRecognition: Reading data...")

        faces, labels = self.prepare_training_data("resources/Faces")
        print("FaceRecognition: Total pictures found: ", len(faces))
        
        #print total faces and labels
        print("FaceRecognition: Trainning face recognition...")
        #create our LBPH face recognizer 
        self.face_recognizer = cv2.face.LBPHFaceRecognizer_create()
        #train our face recognizer of our training faces
        self.face_recognizer.train(faces, np.array(labels))
        print("FaceRecognition: Ready for face recognition")
    ...
    def detect_face(self,img):
        ...
        #face_cascade = cv2.CascadeClassifier('opencv-files/lbpcascade_frontalface.xml')haarcascade_frontalface_alt2.xml
    ...
    def prepare_training_data(self,data_folder_path):
        ...
        for dir_name in dirs:
            ...
            if dir_name.startswith("unknows"):
                continue;
            
            if dir_name.startswith("notFaces"):
                continue;
            ...
            for image_name in subject_images_names:
                ...
                if face is not None:
                    ...
                    print ("Image not detected as a face="+image_path+". Moved into "+"resources/Other/Faces/notFaces"+"/"+image_name)
                    os.rename(subject_dir_path+"/"+image_name,"resources/Other/Faces/notFaces"+"/"+image_name)
